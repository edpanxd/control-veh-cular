...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-xl-12 mb-4">
                  <h1 data-aos="fade-up" data-aos-delay="100">Verificacion B</h1>
                  <div class="mb-2">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><a class="btn btn-danger eliminar" href="php/verificacion_b/eliminar_verificacion_b.php?id=<?php echo $mostrar['id'] ?>&url=<?php echo $mostrar['archivo'] ?>"><i class="icon-trash"></i>
                              </a></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <Form class="form" action="php/verificacion_b/registro_verificacion_b.php" method="POST" enctype="multipart/form-data">
            <div class="container-fluid">
              <div class="row">
  ...
  <div class="modal fade" id="editarverificacion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <Form class="form" action="php/verificacion_b/actualizar_verificacion_b.php" method="POST" enctype="multipart/form-data">
  ...
  <script type="text/javascript">
    ...
    exampleModal.addEventListener('show.bs.modal', function(event) {
      ...
      //
      //
      modalTitle.textContent = 'Editar Verificacion B'
