...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-xl-12 mb-4">
                  <h1 data-aos="fade-up" data-aos-delay="100">Verificacion Federal</h1>
                  <div class="mb-2">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><a class="btn btn-danger eliminar" href="php/verificacion_federal/eliminar_verificacion_federal.php?id=<?php echo $mostrar['id'] ?>&url=<?php echo $mostrar['archivo'] ?>"><i class="icon-trash"></i>
                              </a></td>
  ...
  <!--Modal agregar verificacion_federal -->
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <Form class="form" action="php/verificacion_federal/registro_verificacion_federal.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="form-group ">
                  ...
                  <input type="text" name="federal" class="form-control" required>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    exampleModal.addEventListener('show.bs.modal', function(event) {
      ...
      var modalBodyfederal = exampleModal.querySelector('#federal')
