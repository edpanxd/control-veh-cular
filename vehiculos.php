            ...
            <div class="col-12">
              <div class="row align-items-center">
                ...
                <div class="col-xl-12 mb-4 ">
                  <h1 data-aos="fade-up" data-aos-delay="100">Registro de Vehiculos</h1>
                  <div class="mb-2">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><a class="btn btn-danger eliminar" href="php/Vehiculo/eliminar_vehiculo.php?id=<?php echo $mostrar['id_vehiculo'] ?>"><i class="icon-trash"></i>
                              </a></td>
